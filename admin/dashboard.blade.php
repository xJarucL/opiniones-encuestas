...
@section('content')
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
        ...
        <ul class="divide-y divide-gray-200">
            ...
            {{-- Enlace a Opiniones/Comentarios --}}
            <li class="py-4 flex justify-between items-center hover:bg-gray-50 transition duration-150 px-2 rounded-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.comments.index') }}" class="text-lg font-medium text-gray-800 hover:text-yellow-700">Moderación de Opiniones/Comentarios</a>
            ...
            {{-- Placeholder para Categorías (Si las categorías son de gestión centralizada) --}}
            <li class="py-4 flex justify-between items-center px-2 rounded-lg opacity-60">
                <div class="flex items-center">
